...
class SetupNewRequest extends StatefulWidget {
  SetupNewRequest({Key key}) : super(key: key);

  @override
  _SetupNewRequestState createState() => _SetupNewRequestState();
}

class _SetupNewRequestState extends State<SetupNewRequest> {
  ...
  List<TestModel> _services = TestModel.GetServices();
  List<DropdownMenuItem<TestModel>> _dropdownMenuServicesItems;
  TestModel _selectedServices;
  ...
  void initState() {
    ...
    _dropdownMenuServicesItems = buildDropdownMenuItems(_services);
    _selectedServices = _dropdownMenuServicesItems[0].value;
    super.initState();
  }
  ...
  onChangeDropdownItemServices(TestModel selectedServices) {
    setState(() {
...
//                                    fontWeight: FontWeight.bold
                                      ...
                                      items: _dropdownMenuServicesItems,
                                      onChanged: onChangeDropdownItemServices,
                                    ),
                                  )
                                ],
                              ),
...
//                                            locale: LocaleType.en);
                                        ...
                                        DatePicker.showDatePicker(context,
                                            ...
                                            maxTime: DateTime(2019, 6, 7), onChanged: (date) {
                                              print('change $date');
                                                  ...
                                                  setState(() {
                                               _startTime = DateFormat("dd/MM/yyyy")
                                                    .format(startTime);
                                              });
                                      ...
                                      child: Text(
                                        '${_startTime == "" ? "Request Date" : _startTime}',
                                        style: TextStyle(
                                            color: Colors.grey,
...
//                                            print(startTime);
                                      ...
                                      child: Text(
                                        '${_endTime == "" ? "Request Time" : _endTime}',
                                        style: TextStyle(
                                            color: Colors.grey,
                                            fontWeight: FontWeight.w600,
                                            fontSize: 16.0),
                                      ...
                                      child: MaterialButton(
                                        onPressed: () async{
                                          ...
                                          Navigator.of(context)
                                              .pushReplacement(MaterialPageRoute(builder: (context) => UserHomePage(userId: "user",)));
                                        },
                                        elevation: 0.0,
                                        child: Text(
                                          'Submit Request',
